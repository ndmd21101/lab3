...
(function () {
    ...
    function AddNewTask() {
        ...
        `;
                ...
                messageArea.show().addClass("alert alert-danger").text("Please enter a task.");
            }
        });
    ...
    function CheckLogin() {
        if (sessionStorage.getItem("user")) {
            ...
            if($("#task-list").length==0){
                $("#navigationbar").append(`<li class="nav-item" id="task-list">
                <a class="nav-link" data="task-list"><i class="fas fa-map-signs"></i> Task Lists</a>
              </li>`)
              AddNavigationEvents();
            }
        }
